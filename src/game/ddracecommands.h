...
CONSOLE_COMMAND("dmg", "?v", CFGFLAG_SERVER|CMDFLAG_CHEAT|CMDFLAG_HELPERCMD, ConDamage, this, "..", 3)
CONSOLE_COMMAND("damage", "?v", CFGFLAG_SERVER|CMDFLAG_CHEAT|CMDFLAG_HELPERCMD, ConDamage, this, "..", 3)
CONSOLE_COMMAND("undmg", "?v", CFGFLAG_SERVER|CMDFLAG_CHEAT|CMDFLAG_HELPERCMD, ConUnDamage, this, "..", 3)
CONSOLE_COMMAND("undamage", "?v", CFGFLAG_SERVER|CMDFLAG_CHEAT|CMDFLAG_HELPERCMD, ConUnDamage, this, "..", 3)
CONSOLE_COMMAND("icehammer", "?v", CFGFLAG_SERVER|CMDFLAG_CHEAT|CMDFLAG_HELPERCMD, ConIceHammer, this, "..", 3)
CONSOLE_COMMAND("unicehammer", "?v", CFGFLAG_SERVER|CMDFLAG_CHEAT|CMDFLAG_HELPERCMD, ConUnIceHammer, this, "..", 3)
